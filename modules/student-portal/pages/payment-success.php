    ...
    try {
        ...
        if ($pdo) {
            ...
            if (!$paymentData) {
                ...
                $accessDenied = true;
            } elseif ($paymentData['payment_status'] === 'Pending') {
                // The redirect is not proof of payment. The PayMongo webhook
                // is the only path that verifies and allocates the payment.
            }
        }
    } catch (Exception $e) {
        $accessDenied = true;
